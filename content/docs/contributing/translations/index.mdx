...
Fleetbase is modular. The Console (the main app shell) and every extension (Fleet-Ops, Storefront, Pallet, Ledger, IAM, etc.) ship their own translation files. To deliver a complete experience in a language, you typically need to contribute to multiple repos — but you can start with just one.
