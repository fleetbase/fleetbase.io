...
The first-party extensions (Fleet-Ops, Storefront, Pallet, Ledger, IAM) are open-source and accept community contributions. You can:
...
- A **local Fleetbase instance** for development (see [System Setup](/docs/platform/system-setup/branding))
