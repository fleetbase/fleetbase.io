...
| [`addon/services/universe/menu-service.js`](https://github.com/fleetbase/ember-core/blob/main/addon/services/universe/menu-service.js) | Backing service for menu items |
| [`addon/services/universe/registry-service.js`](https://github.com/fleetbase/ember-core/blob/main/addon/services/universe/registry-service.js) | Backing service for components |
