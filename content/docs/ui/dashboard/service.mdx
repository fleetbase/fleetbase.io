...
| [`addon/services/universe/widget-service.js`](https://github.com/fleetbase/ember-core/blob/main/addon/services/universe/widget-service.js) | Companion service — manages the registry of available widgets |
