...
Pallet automatically maintains a comprehensive audit trail for every item in your [Inventory](/docs/pallet/inventory/overview).
...
3. Select the specific [Warehouse](/docs/pallet/warehouses/overview) and the specific area (e.g., a single Zone or Aisle) you want to audit.
