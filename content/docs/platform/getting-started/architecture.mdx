...
<Callout type="info">
  Planning a self-hosted or on-premise production deployment? See [Infrastructure Sizing](/docs/platform/quickstart/infrastructure-sizing) for the recommended HA topology, bill of quantities, workload profiles, and storage formulas.
</Callout>
...
Console users sign in with a password or, when an administrator has configured it, with a Google, Microsoft, GitHub, or Apple account — see [OAuth Sign-in](/docs/platform/system-setup/oauth-sign-in). Either way the console ends up holding a session token.
...
This is what allows extensions to appear seamlessly inside the console without modifying the core application. See the [Extension Development documentation](/docs/extension-development/universe/overview) for full details.
...
- [Extension Development](/docs/extension-development/getting-started/quickstart) — start building your own extensions
