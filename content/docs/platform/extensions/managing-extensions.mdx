...
![Installed extensions — card grid with extension icon, name, description, About and Uninstall buttons](/images/screenshots/extensions/extensions-installed.webp)
...
![Uninstall confirmation modal — extension name, warning text, and 3-step progress bar](/images/screenshots/extensions/extensions-uninstall.webp)
...
<Callout type="warn">Uninstalling an extension may permanently delete the data it managed — for example, uninstalling Fleet-Ops removes driver and vehicle records. Back up any data you need before proceeding.</Callout>
