...
![Roles list — Name, Description, Service, Type, Created columns](/images/screenshots/iam/iam-roles-management.webp)
...
![Role form — Name, Description, Attach Policies, and Permission Picker grid](/images/screenshots/iam/iam-create-role.webp)
