...
![Groups list — Name, Description, Members avatar stack, Created columns](/images/screenshots/iam/iam-groups-management.webp)

## Creating a Group

Click **New** to create a group.

![Group form — Name, Description, and member search list](/images/screenshots/iam/iam-create-group.webp)
...
![Group member list with remove buttons and user search selector](/images/screenshots/iam/iam-manage-group-members.webp)
