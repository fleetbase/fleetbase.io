...
| **System-wide** | Admin → Auth Config → Two-Factor Auth | Instance admins for all organizations |

2FA applies however you sign in. If you [sign in with a provider](/docs/platform/identity-and-access/oauth-sign-in), you are still asked for your one-time code afterwards.
...
Instance administrators can enable and enforce 2FA across the entire Fleetbase instance — for all users in all organizations. This is configured from **Admin → Auth Config → Two-Factor Auth**.
