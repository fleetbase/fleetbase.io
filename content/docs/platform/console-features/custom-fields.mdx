...
The Custom Fields Manager is embedded inside the settings panel of each extension that supports it (for example, **Fleet-Ops → Settings → Custom Fields**).

![Custom Fields Manager — resource type tabs, field groups as panels, fields with type pills and edit/delete buttons](/images/screenshots/fleet-ops/fleet-ops-custom-fields.webp)
...
![Custom field form — Label, Description, Help Text, Required/Editable toggles, Field Type, Options, and Column Span](/images/screenshots/fleet-ops/fleet-ops-create-custom-field.webp)
