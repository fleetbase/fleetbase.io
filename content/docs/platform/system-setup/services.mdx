...
![Services settings — AWS, Google Maps, Twilio, Sentry, and IP Info configuration sections](/images/screenshots/admin/admin-services.webp)

<Callout type="info">
  For production infrastructure planning, including required external connectivity and service dependencies, see [Infrastructure Sizing](/docs/platform/quickstart/infrastructure-sizing).
</Callout>
