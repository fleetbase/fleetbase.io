...
<Callout type="info">
  For WebSocket ingress requirements, SocketCluster replica guidance, and network planning, see [Infrastructure Sizing](/docs/platform/quickstart/infrastructure-sizing).
</Callout>
