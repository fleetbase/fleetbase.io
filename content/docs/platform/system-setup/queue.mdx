...
![Queue settings — Driver dropdown and connection configuration fields](/images/screenshots/admin/admin-queue.webp)

<Callout type="info">
  For production worker sizing, queue scaling, and monitoring guidance, see [Infrastructure Sizing](/docs/platform/quickstart/infrastructure-sizing).
</Callout>
