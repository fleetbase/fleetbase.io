...
<Callout type="info">
  For storage growth formulas, backup targets, and production object-storage guidance, see [Infrastructure Sizing](/docs/platform/quickstart/infrastructure-sizing).
</Callout>
