...
<Steps>
  ...
  <Step>
    Enter the Merchant Backend URL, instance ID, API token, and the currencies this gateway should accept.
  </Step>
  <Step>
...
TALER_E2E_BACKEND_URL=https://merchant-backend.example
