...
<Callout type="info">
  **Full license text:** [github.com/fleetbase/fleetbase/blob/main/LICENSE.md](https://github.com/fleetbase/fleetbase/blob/main/LICENSE.md)
</Callout>

## Open-Source License — AGPL-3.0

The entire Fleetbase platform — the core API, Console, official extensions (Fleet-Ops, Storefront, Pallet, Ledger), and the mobile apps (Navigator App, Storefront App) — is released under the **GNU Affero General Public License v3.0 (AGPL-3.0)**.
