...
Real example: [`packages/storefront/addon/extension.js:55`](https://github.com/fleetbase/storefront/blob/main/addon/extension.js#L55).
...
Real example: [`packages/ledger/addon/extension.js:185`](https://github.com/fleetbase/ledger/blob/main/addon/extension.js#L185) — Ledger registers its own dashboard, attaches its full widget set there, and additionally exposes a curated subset on the built-in `'dashboard'`.
...
| [`packages/storefront/addon/extension.js`](https://github.com/fleetbase/storefront/blob/main/addon/extension.js) | Single-widget on built-in dashboard |
| [`packages/ledger/addon/extension.js`](https://github.com/fleetbase/ledger/blob/main/addon/extension.js) | Custom dashboard + widget set |
