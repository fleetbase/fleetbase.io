...
Real example: [`packages/fleetops/addon/routes.js`](https://github.com/fleetbase/fleetops/blob/main/addon/routes.js).
...
| [`packages/fleetops/addon/engine.js`](https://github.com/fleetbase/fleetops/blob/main/addon/engine.js) | Reference engine class |
| [`packages/fleetops/addon/routes.js`](https://github.com/fleetbase/fleetops/blob/main/addon/routes.js) | Reference route map |
