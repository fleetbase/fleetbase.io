...
<Callout type="info">This is social sign-in for Storefront **customers**. For your own team signing in to the Fleetbase console with Google, Microsoft, GitHub, or Apple, see [OAuth Sign-in](/docs/platform/system-setup/oauth-sign-in).</Callout>
