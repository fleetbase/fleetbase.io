...
If you need to create zones programmatically — from a radius around a point, or from a pre-drawn GeoJSON polygon — use the [API](#api) instead. Those options are not exposed in the UI.
