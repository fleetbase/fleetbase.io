...
All three power the geofence widgets on the Fleet-Ops **Analytics → Reports** dashboards.
...
See [Identity & Access](/docs/platform/identity-and-access/roles-and-permissions) for how to assign these permissions.
