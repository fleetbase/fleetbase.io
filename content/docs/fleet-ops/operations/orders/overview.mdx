...
![Orders list — status filter tabs, search bar, order rows with status badges](/images/screenshots/fleet-ops/fleet-ops-orders-table-list.webp)
...
- [Order Lifecycle](/docs/fleet-ops/operations/orders/order-lifecycle) — the five system statuses and how the activity flow runs inside them
