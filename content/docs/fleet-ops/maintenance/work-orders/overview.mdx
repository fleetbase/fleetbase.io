...
A work order can be opened from a failed inspection, with a checklist item for each failed check. The work order's details then show a **Linked Inspection** section. Click the inspection to open it and see the answers, photos, and who filed it. See [Reviewing & Follow-up](/docs/fleet-ops/maintenance/inspections/reviewing-and-follow-up).
