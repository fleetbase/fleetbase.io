...
An issue can be raised from a failed inspection, either with **Create Issue** on the inspection or automatically when the inspection form is set up to do so. The issue's details then show a **Linked Inspection** section. Click the inspection to open it and see the failed checks, photos, and who filed it. See [Reviewing & Follow-up](/docs/fleet-ops/maintenance/inspections/reviewing-and-follow-up).
