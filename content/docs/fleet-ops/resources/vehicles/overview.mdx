...
**Vehicles** are powered fleet assets assigned to carry out orders. Each vehicle record stores physical details, capacity specifications, real-time location, and links to the driver, maintenance schedules, connected devices, directly attached equipment, and currently connected Trailers.

![Vehicle position playback — a vehicle's recent route on the live map with timeline scrubber](/images/screenshots/fleet-ops/fleet-ops-vehicle-position-playback.webp)
...
- **Trailers** — active towed-asset connections, with attach and detach controls
- **Equipment** — auxiliary gear attached directly to the Vehicle
...
- **Inspections** — every inspection filed against the vehicle, with its result and failed checks (see [Inspections](/docs/fleet-ops/maintenance/inspections/overview))
...
- [Trailers](/docs/fleet-ops/resources/trailers/overview) — first-class towed assets and connection history
- [Maintenance](/docs/fleet-ops/maintenance/overview) — schedules and work orders
- [Inspections](/docs/fleet-ops/maintenance/inspections/overview) — vehicle inspections and follow-up of failed checks
