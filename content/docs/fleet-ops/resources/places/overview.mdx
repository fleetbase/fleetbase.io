...
![Places list — place name, type badge, address, and linked contact](/images/screenshots/fleet-ops/fleet-ops-places-list.webp)
...
See [Service Rates](/docs/fleet-ops/operations/service-rates/overview) for how Service Areas and Zones scope pricing.
